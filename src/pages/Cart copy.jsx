export default function Cart() {
    ...
    return (
        <section id="shopping_cart" className="my-4 container">
                ...
                <div className="col-md-8 cart">
                    ...
                    <div className="row border-top border-bottom">
                        <div className="row main align-items-center">
                            ...
                            <div className="col">
                                <div className="row">nome prodotto</div>
                            </div>
                            <div className="col">
                    ...
                    <div className="back-to-shop"><a href="#">freccia</a><span className="text-muted">Back to shop</span></div>
                </div>
